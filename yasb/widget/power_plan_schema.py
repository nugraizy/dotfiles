...
VALIDATION_SCHEMA = {
    ...
    "icons": {
        ...
        "schema": {
            "balanced": {"type": "string", "default": DEFAULTS["icons"]["balanced"]},
            "high-performance": {"type": "string", "default": DEFAULTS["icons"]["high-performance"]},
            "power-saver": {"type": "string", "default": DEFAULTS["icons"]["power-saver"]},
            "ultimate-performance": {"type": "string", "default": DEFAULTS["icons"]["ultimate-performance"]},
        }
    }
}